...
public class TransactionController {
    ...
    public ResponseEntity<String> issueBook(@PathVariable("bookId") Integer bookId, @PathVariable("cardId") Integer cardId){
        try{
    ...
    public ResponseEntity<String> returnBook(@PathVariable("bookId") Integer bookId, @PathVariable("cardId") Integer cardId){
        try{
